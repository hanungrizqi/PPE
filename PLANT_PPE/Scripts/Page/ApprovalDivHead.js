...
var table = $("#tbl_ppe_eng").DataTable({
    ajax: {
        //url: $("#web_link").val() + "/api/PPE/Get_ListApprovalDivHead_ENG/" + $("#hd_PositionID").val(),
        url: $("#web_link").val() + "/api/PPE/Get_ListApprovalDivHead_ENG",
        dataSrc: "Data",
    },
...
table.on('draw', function () {
    var visibleCheckboxes = document.querySelectorAll('#tbl_ppe_eng tbody .row-checkbox:checked');
