...
function submitApproval(postStatus) {
    ...
    dataEQP.POSISI_PPE = postStatus === "REJECT" ? "Project Manager Pengirim" : "Project Manager Penerima";
    dataEQP.UPDATED_BY = $("#hd_nrp").val();
    dataEQP.STATUS = postStatus;
    dataEQP.APPROVAL_ORDER = 5;
    dataEQP.URL_FORM_PM_PENERIMA = "http://10.14.101.181/ReportServer_RPTPROD?/PPE/Rpt_PPE_PMPenerima&PPE_NO=" + $("#txt_noPPE").val();
    ...
    $.ajax({
        url: $("#web_link").val() + "/api/DetailApproval/Approve_PPE_PMPengirim",
